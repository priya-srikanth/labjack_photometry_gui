...
For bench tests, `0 Hz` modulation means a static DAC output at the requested offset voltage. Nonzero DAC sine waves are generated by LabJack stream-out updates, and the GUI reports the actual programmed carrier frequency after Start.
